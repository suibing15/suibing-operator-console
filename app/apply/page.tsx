      ...
      <div className="split">
        <aside className="panel">
          <div className="panelInner">
            ...
            <h1>School software and services, built for Nigerian schools.</h1>
            <p className="tagline">Records, examinations, fees, and more — one company, one point of contact, from setup through to support.</p>
            <ul className="points">
...
const styles = `
  ...
  input, select, textarea { width: 100%; border: 1px solid var(--line-strong); border-radius: var(--radius-sm); padding: 11px 13px; font-size: 14px; font-family: inherit; background: #fff; transition: border-color 0.15s; }
