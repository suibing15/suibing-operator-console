      ...
      <div className="split">
        <aside className="panel">
          <div className="panelInner">
            ...
            <h1>Your invoices, whenever you need them.</h1>
            <p className="tagline">Look up and download any invoice issued to your school — registration, subscription renewals, or custom work.</p>
            <ul className="points">
          ...
          <div className="formCard wide">
            ...
            {invoices && (
              <div className="invList">
                {invoices.map((inv) => (
                  <div key={inv.invoice_number} className="invCard">
...
const styles = `
  ...
  .formCard { background: #fff; border: 1px solid var(--line); border-radius: 16px; box-shadow: 0 4px 24px rgba(20,28,45,0.06); padding: 36px; width: 100%; max-width: 440px; }
  ...
  input { width: 100%; border: 1px solid var(--line-strong); border-radius: var(--radius-sm); padding: 11px 13px; font-size: 14px; font-family: inherit; background: #fff; }
  ...
  .invCard { border: 1px solid var(--line); border-radius: var(--radius-sm); padding: 14px 16px; }
